...
Example:
  python fit6_1_train_narx_from_csvs_z.py \
...
def train(args):
    ...
    # ---- NEW: fit dz surrogate f_z(ps) on quasi-static samples from stat CSVs
    fz_meta = None
    if args.stat_csvs:
        try:
    ...
    meta = {
        ...
        # ---- NEW: dz surrogate coefficients (if available)
